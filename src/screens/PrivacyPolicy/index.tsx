...
export const PrivacyPolicy = () => (
  <>
    ...
    <p>
      ...
      advertising partners of body-monitor.
    </p>
    ...
    <p>
      Note that body-monitor has no access to or control over these cookies that
    ...
    <p>
      body-monitor does not knowingly collect any Personal Identifiable
